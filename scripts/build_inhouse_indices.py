...
def main(args):
    ...
    indices_path = os.path.join(args.root_dir, args.dataset, 'inhouse', args.text_encoder, 'bin',
                                '{}.inhouse_indices.pk'.format(args.split))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='csqa', type=str, choices=['csqa', 'obqa'])
